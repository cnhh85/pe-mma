export const DB = [
  ...
  {
    title:
      "Strategies for Teaching Speaking Skills – Seminar for FPT Education's faculty members",
    description:
      "On August 16, the seminar Strategies for Teaching Speaking Skills will be held at FPT Polytechnic, Hanoi with the participation of Dr. Roselind Wan, from Universiti Teknologi PETRONAS (UTP).",
    content:
